...
def build_startup_message(candidate_id: str, state: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"Execution: {'ENABLED' if bridge.get('execution_enabled') else 'DISABLED (dry-run)'}",
        ...
        "",
        "📊 <b>Evidencia</b>",
        f"Decisiones: {ev.get('decisions', 0)} | Outcomes: {ev.get('outcomes', 0)} | Live orders: {ev.get('live_orders', 0)} | Incidentes: {ev.get('incidents', 0)}",
        "",
        "💼 <b>Posiciones</b>",
