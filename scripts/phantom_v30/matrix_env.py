...
class PhantomMatrixEnv(VecEnv):
    ...
    def step_wait(self):
        ...
        HARD_STOP = -0.025   # -2.5% price = -50% ROE @ 20x
        TAKE_PROFIT = 0.0125 # 1.25% price = +25% ROE @ 20x
        ...
        TRAILING_ACTIVATION = 0.15 / LEVERAGE  # 0.0075 raw
        TRAILING_CALLBACK = 0.015              # 1.5% callback from peak
